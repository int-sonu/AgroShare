        ...
        <div className="bg-green-600 p-6 text-white relative">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-green-100 text-[12px] font-bold uppercase tracking-widest">
        ...
        <div className="flex-1 overflow-y-auto p-6 scrollbar-hide">
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-20 text-center">
              ...
              <p className="text-[13px] font-medium text-gray-400 max-w-[200px]">
                We don&apos;t have any machinery listed in &quot;{search}&quot; yet.
              </p>
            </div>
          )}
        </div>
